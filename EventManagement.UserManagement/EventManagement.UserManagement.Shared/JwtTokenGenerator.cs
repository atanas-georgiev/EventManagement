namespace EventManagement.UserManagement.Shared
{
    ...
    public sealed class JwtTokenGenerator : IJwtTokenGenerator
    {
        ...
        {
            this.tokenOptions = tokenOptions ?? throw new ArgumentNullException(
        ...
        public TokenWithClaimsPrincipal GenerateAccessTokenWithClaimsPrincipal(
            string userName,
            ...
            return new TokenWithClaimsPrincipal()
                       {
                           ...
                           ClaimsPrincipal =
                               ClaimsPrincipalFactory.CreatePrincipal(
                                   MergeUserClaimsWithDefaultClaims(
                                       userName,
                                       userClaimList)),
        ...
        private static AuthenticationProperties CreateAuthProperties(string accessToken)
        {
            ...
            authProps.StoreTokens(
                new[] { new AuthenticationToken() { Name = TokenConstants.TokenName, Value = accessToken } });
